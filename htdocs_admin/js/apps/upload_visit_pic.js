(function() {
	...
	function _loadLogoPic(picURL, picTag) {
		var img = '<div class="img_item brick" data-pic="' + picTag + '" style="float: left; width: 250px; height: 250px; margin: 20px;">' +
			'<img style="max-width: 250px; max-height: 250px;" src="' + picURL + '" />' +
			'<div style="margin-bottom: 5px; margin-top: 5px;">' +
			'<a style="margin-right:10px;" href="#" onclick="delete_pic(\''+picTag+'\');return false;" class="btn btn-default">删除</a>' +
			'</div>' +
			'</div>';
