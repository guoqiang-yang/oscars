...
class App extends App_Admin_Page
{
    ...
    protected function getPara()
    {
        $this->searchConf = array(
            ...
            'order_type' => Conf_Stock::OTHER_STOCK_ORDER_TYPE_OUT,
    ...
    protected function outputBody()
    {
        ...
        $app = '/warehouse/other_stock_out_order.php?' . http_build_query($this->searchConf);
        ...
        $this->smarty->display('warehouse/other_stock_out_order.html');
    }
