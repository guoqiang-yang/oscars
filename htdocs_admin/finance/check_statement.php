...
class App extends App_Admin_Page
{
    ...
    {
        parent::checkAuth('/order/check_statement');
    }
    ...
    protected function getPara()
    {
        $this->searchConf = array(
            ...
            'step' => Tool_Input::clean('r', 'step', TYPE_STR),
        ...
        {
            $this->searchConf['step'] = Conf_Coopworker::STATEMENT_STEP_SURE;
        }
    }
    ...
    protected function main()
    {
        ...
        unset($this->statementStepList[Conf_Coopworker::STATEMENT_STEP_CREATE]);
    ...
    protected function outputBody()
    {
        ...
        $this->smarty->assign('statement_steps', Conf_Coopworker::$Statement_Step);
        ...
        $this->smarty->display('order/check_statement.html');
    }
}
