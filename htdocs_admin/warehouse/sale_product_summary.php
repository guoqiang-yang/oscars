...
class App extends App_Admin_Page
{
    ...
    {
        parent::checkAuth('/order/sale_product_summary');
    }
    ...
    {
		$this->plist = Order_Api::getSaleProductsSummary($this->bdate, $this->edate, $this->btype, $this->pSearchCate, $this->wid, $this->start, $this->num);
	}

	protected function outputBody()
    {
		$app = '/warehouse/sale_product_summary.php?bdate=' . $this->bdate . '&edate=' . $this->edate . '&btype=' . $this->btype . '&product_search_cate=' . $this->pSearchCate;
		...
		$this->smarty->assign('totalPrice', $this->plist['total_price']);

		$this->smarty->display('order/sale_product_summary.html');
	}
}
