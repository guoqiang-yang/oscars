...
class App extends App_Admin_Page
{
    ...
    protected function main()
    {
        ...
        $this->addFootJs(array(
                             'js/apps/highcharts/logistics.js',
                         ));
        $this->addCss(array(
                          'css/highcharts/unica_one.css'
                      ));

        $this->data = Statistics_Api::getLogisticsInfo($this->days, $this->cityId);
    }
    ...
    protected function outputBody()
    {
        ...
        $this->smarty->assign('carry', json_encode($this->data['carry']));
        $this->smarty->assign('freight', json_encode($this->data['freight']));
        $this->smarty->assign('city_id', $this->cityId);
        $this->smarty->assign('city_list', Conf_City::$CITY);

        $this->smarty->display('statistics/logistics.html');
    }
}
